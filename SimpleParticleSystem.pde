...
void update(float dt){
  ...
  for (int i = 0; i < toGen; i++){
    ...
    vel[numParticles] = new Vec2(random(30,90),random(-190,-200));
    numParticles += 1;
  }
  ...
  if(shiftPressed) {
    if (leftPressed) obstacleVel = new Vec2(-obstacleSpeed,0).times(2);
    if (rightPressed) obstacleVel = new Vec2(obstacleSpeed,0).times(2);
    if (upPressed) obstacleVel = new Vec2(0,-obstacleSpeed).times(2);
    if (downPressed) obstacleVel = new Vec2(0,obstacleSpeed).times(2);  
    if(leftPressed && upPressed) obstacleVel = new Vec2(-obstacleSpeed,-obstacleSpeed).times(1.5);
    if(leftPressed && downPressed) obstacleVel = new Vec2(-obstacleSpeed,obstacleSpeed).times(1.5);
    if(rightPressed && upPressed) obstacleVel = new Vec2(obstacleSpeed,-obstacleSpeed).times(1.5);
    if(rightPressed && downPressed) obstacleVel = new Vec2(obstacleSpeed,obstacleSpeed).times(1.5);
    ...
    if(leftPressed && upPressed) obstacleVel = new Vec2(-obstacleSpeed,-obstacleSpeed).times(.75);
    if(leftPressed && downPressed) obstacleVel = new Vec2(-obstacleSpeed,obstacleSpeed).times(.75);
    if(rightPressed && upPressed) obstacleVel = new Vec2(obstacleSpeed,-obstacleSpeed).times(.75);
    if(rightPressed && downPressed) obstacleVel = new Vec2(obstacleSpeed,obstacleSpeed).times(.75);
  }
